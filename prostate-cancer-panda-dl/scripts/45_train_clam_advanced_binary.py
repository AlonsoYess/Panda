"""Train CLAM binary MIL on advanced Virchow2, UNI2-h or Prov-GigaPath embeddings."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Entrena CLAM binario con embeddings advanced Virchow2/UNI2-h/Prov-GigaPath."
    )
    parser.add_argument(
        "--config",
        type=Path,
